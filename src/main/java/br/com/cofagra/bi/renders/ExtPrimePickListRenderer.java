...
public class ExtPrimePickListRenderer extends PickListRenderer{
     ...
     protected void encodeMarkup(FacesContext context, PickList pickList) throws IOException {
          ...
          /**
           * Se for inv�lido ent�o colocar a classe CSS para marcar como erro
           */
          styleClass = pickList.isValid() ? styleClass : styleClass + " ui-state-error";
     ...
     protected void encodeScript(FacesContext context, PickList pickList) throws IOException {
          ...
          wb.widget("PickList", pickList.resolveWidgetVar(), clientId, true).attr("effect", pickList.getEffect()).attr("effectSpeed", pickList.getEffectSpeed()).attr("showSourceControls", pickList.isShowSourceControls(), false).attr("showTargetControls", pickList.isShowTargetControls(), false).attr("disabled", pickList.isDisabled(), false).attr("filterMatchModel", pickList.getFilterMatchMode(), null).attr("filterFunction", pickList.getFilterFunction(), null).attr("showCheckbox", pickList.isShowCheckbox(), false).callback("onTransfer", "function(e)", pickList.getOnTransfer());
