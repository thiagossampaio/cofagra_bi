 ...
 */
@Log
public class ExtPrimeAutoCompleteRenderer extends AutoCompleteRenderer{
...
//          styleClass = styleClass == null ? AutoComplete.STYLE_CLASS : AutoComplete.STYLE_CLASS + " " + styleClass;
          styleClass = styleClass == null ? AutoComplete.STYLE_CLASS : AutoComplete.STYLE_CLASS;
     ...
     protected void encodeInput(FacesContext context, AutoComplete ac, String clientId, Object value) throws IOException {
          ...
          String defaultStyleClass = ac.isDropdown() ? AutoComplete.INPUT_WITH_DROPDOWN_CLASS + " " + ac.getStyleClass() : AutoComplete.INPUT_CLASS + " " + ac.getStyleClass();
     ...
     protected void encodeScript(FacesContext context, AutoComplete ac) throws IOException {
          ...
          if (ac.getProcess() != null)
               writer.write(",process:'" + ComponentUtils.findClientIds(context, ac, ac.getProcess()) + "'");
